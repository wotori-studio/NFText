/*
This code taken from here https://github.com/archway-network/dApp-examples/tree/main/react/increment
For educational purpose. Will be removed in the future.
*/
          ...
          <div key={logMeta[i].timestamp}>
            <p className="label">
              <strong>
                <span>
                  Counter{" "}
                  {logMeta[i].type === "increment" ? "Incremented" : "Reset"}
                  &nbsp;
                </span>
                ({logMeta[i].timestamp}):
              </strong>
